function result = receiver_Cap_mode1(rx, fh_pat, th_pat, wav_S1, wav_S2, tag, time_frame, num_pulses)
...
% 同步头消除频偏
counter_f_S1 = repmat(DF_hat_S12,[num_pulses,1]) * 2 * pi * t2(8:oversamp_BB:24*oversamp_IF) * T;
counter_f_S2 = repmat(DF_hat_S12,[num_pulses,1]) * 2 * pi * t2(280*oversamp_IF+8:oversamp_BB:280*oversamp_IF+24*oversamp_IF) * T;
